...
// ---------- Sample Data ----------
const sampleImage = { cricketHero }; // cricket stadium (real image via Unsplash search)
...
const leagues = [
  {
    key: "football",
    name: "Football",
    comps: ["Premier League", "LaLiga", "Serie A"],
    Icon: FaFutbol,
  },
  {
    key: "cricket",
...
const teams = [
  { name: "Mumbai Meteors", tag: "MM", sport: "Cricket" },
  { name: "Thane Titans", tag: "TT", sport: "Football" },
  { name: "Vashi Vipers", tag: "VV", sport: "Basketball" },
  { name: "Dadar Dragons", tag: "DD", sport: "Cricket" },
  { name: "Kolkata Knights", tag: "KK", sport: "Football" },
  { name: "Bengaluru Blaze", tag: "BB", sport: "Basketball" },
  { name: "Chennai Chargers", tag: "CC", sport: "Cricket" },
  { name: "Pune Panthers", tag: "PP", sport: "Football" },
];
...
const CRICKET_IMAGES = [
  "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRNqADSDBmnXROBJO92TuNeuDy74lJwKIgdOA&s",
  "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTKzKalciRlSv9dlJUf7l0of3dY6iRcqb55-g&s",
  "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSyYOGRBcNujI0l41PDgV9vOjX3bKlxGhlVVg&s",
  "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQnSKQeHotuTQku8-O4c7e4jB0rpUKyC4t8Vg&s",
];
  ...
  return (
    <section className="relative">
      ...
      <div className="relative mx-auto flex h-[62vh] max-w-7xl flex-col items-start justify-center px-4 text-white">
        ...
        <h1 className="mt-4 text-4xl font-extrabold leading-tight md:text-6xl Gilda">
          ...
          {liveScores.map((m) => (
            <div key={m.id} className="rounded-xl bg-white/5 p-4">
              ...
              <div className="mt-1 flex items-center justify-between text-white">
                ...
                <span className="rounded-md bg-emerald-600/90 px-2 py-1 text-sm font-bold shadow">
                  {m.score}
                </span>
...
function CTA() {
  return (
    <section id="cta" className="mx-auto mt-24 max-w-7xl px-4 text-white">
      <div className="relative overflow-hidden rounded-3xl border border-white/10 bg-gradient-to-br from-indigo-700 via-teal-700 to-emerald-700 p-10 shadow-2xl">
        ...
        <div className="relative grid gap-12 md:grid-cols-2 md:items-center">
          ...
          <div className="space-y-6">
            <div>
              <h3 className="text-4xl font-extrabold leading-tight sm:text-5xl Gilda">
                Stay Updated
                <br />
                <span className="text-emerald-300 Gilda">
                  Never miss a match.
                </span>
              </h3>
              <p className="mt-3 text-white/90 max-w-md">
                Be the first to know every time your favorite team scores, wins,
                or breaks a record. Real-time updates, match recaps, and weekly
            ...
            >
              <input
                ...
                className="w-full rounded-xl border border-white/20 bg-white/10 px-4 py-3 text-white placeholder-white/70 outline-none backdrop-blur transition focus:border-white/40 focus:ring-2 focus:ring-emerald-400/40"
              />
              <button className="rounded-xl bg-white px-6 py-3 font-semibold text-slate-900 shadow hover:bg-emerald-100 transition">
                Notify me
              </button>
            </form>
